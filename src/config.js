...
export async function gasGet(baseUrl, params = {}) {
...
export const SCORE_COLORS = { excellent: '#34d399', good: '#ff6b2b', poor: '#f87171' };
...
export function getScoreColor(score) { return SCORE_COLORS[getScoreClass(score)]; }
